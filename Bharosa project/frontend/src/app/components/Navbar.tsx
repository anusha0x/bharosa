      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">BHAROSA</span>
          </Link>

          <div className="hidden md:flex items-center gap-6">
            <Link to="/scholarships" className="text-sm text-muted-foreground hover:text-primary transition-colors">Scholarships</Link>
            <Link to="/applications" className="text-sm text-muted-foreground hover:text-primary transition-colors">My Applications</Link>
            ...
            {isAuthenticated ? (
              <>
                <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/5 rounded-lg">
                  ...
                  <span className="text-sm text-primary hidden sm:block">{user?.name || user?.mobile}</span>
                </div>
